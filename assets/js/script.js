$(function () {
  ...
  /*banner section slider end*/
   ...
   $('.featured_category_slider').slick({
      slidesToShow: 10,
      slidesToScroll: 3,
      prevArrow: '<i class="fas fa-long-arrow-alt-left featured_slide_icon slider_icon slider-left feature-left"></i>',
      nextArrow: '<i class="fas fa-long-arrow-alt-right featured_slide_icon slider_icon slider-right feature-right"></i>',
      responsive:[
        {
          breakpoint:1200,
          settings:{
